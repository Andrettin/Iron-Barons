...
Rectangle {
	...
	SmallText {
		...
		text: "(" + number_string(country_game_data.current_research ? country_game_data.current_research.get_commodity_costs_for_country_qvariant_list(country)[0].value : 0) + ")"
