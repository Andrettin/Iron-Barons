...
DialogBase {
	...
	Rectangle {
		...
		anchors.right: parent.right
		anchors.bottom: military_unit_grid.top
	...
	Grid {
		...
		Repeater {
			model: (selected_province !== null && selected_garrison) ? selected_province.game_data.military_units : []
	...
	Rectangle {
		color: "gray"
		anchors.top: military_unit_grid.top
		anchors.bottom: parent.bottom
